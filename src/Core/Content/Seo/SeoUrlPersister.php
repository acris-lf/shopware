    ...
    private function updateDefaultSeoUrls(array $seoUrls): void
    {
        ...
        foreach ($seoUrls as $seoUrl) {
            $id = $this->connection->fetchOne(
                'SELECT HEX(id) as id FROM seo_url WHERE language_id = :languageId AND foreign_key = :foreignKey AND sales_channel_id = :salesChannelId AND route_name = :routeName ORDER BY created_at ASC LIMIT 1',
                [
